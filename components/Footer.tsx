    ...
    <footer className="bg-gray-800 text-gray-300">
      <div className="container mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-2">
            <h3 className="text-2xl font-bold text-emerald-500">Many BrIAx</h3>
          ...
          <div id="contact">
            ...
            <ul className="space-y-3 text-gray-400">
              <li><a href="mailto:contato@manybriax.com.br" className="hover:text-emerald-400 transition-colors">contato@manybriax.com.br</a></li>
      ...
      <div className="bg-gray-900 py-4">
        <div className="container mx-auto px-6 text-center text-gray-500 text-sm">
          © {new Date().getFullYear()} Many BrIAx. {t.footer.rights}
        </div>
      </div>
    </footer>
  );
